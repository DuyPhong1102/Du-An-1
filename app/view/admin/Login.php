...
<body>
                    ...
                    <form id="loginForm" method="post">
                        <div class="wrap-input100 validate-input">
                            <div>
                                ...
                                <input style="position: relative;" class="input100" type="text" autofocus autocomplete="on" placeholder="Tài khoản quản trị" value="<?php echo isset($_POST["email"]) ? $_POST["email"] : ""; ?>" name="email" id="username">
                        ...
                        <div class="wrap-input100 validate-input">
                            <div>
                                <input style="position: relative;" autocomplete="off" class="input100" type="password" name="password" placeholder="Mật khẩu" name="current-password" id="password-field">
    ...
    <!--Javascript-->
    <script src="<?php echo _WEB_ROOT; ?>/app/public/assets/admin/js/Login.js"></script>
