        ...
        <div class="tile">
          <div class="tile-body">
            <div class="row element-button">
              ...
              <div class="col-sm-2">
                <button class="btn btn-delete deleteById btn-sm" type="button" title="Xóa"><i class="deleteById fas fa-trash-alt"></i> Xóa </b>
              </div>
            </div>
            <div id="sampleTable_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer" style="margin-bottom:15px;">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-5">
                  <div class="dataTables_info" id="sampleTable_info" role="status" aria-live="polite">Hiện 11 đến 16 của 16 danh mục</div>
                </div>
...
-->
  ...
  <script defer src="<?php echo _WEB_ROOT; ?>/app/public/assets/admin/js/DataProduct.js"></script>
