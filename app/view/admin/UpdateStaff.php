      ...
      <div class="tile">
        ...
        <div class="tile-body">
          ...
          <form id="formUpdate"method="post" class="row">
              ...
              <input required class="form-control" name="name" type="text" value="<?=  $dataStaffById["username"];?>">
              <small></small>
              <span></span>
            </div>
            ...
            <div class="form-group col-md-3">
              ...
              <input required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,63}$" class="form-control"value="<?=  $dataStaffById["email"];?>" name="email" type="text">
              <small></small>
              <span></span>
            </div>
            ...
            <div class="form-group col-md-3">
              ...
              <select required class="form-control"name="position" >
                <?php foreach ($allPosition as $item) {
                    if($item["id_position"]==$dataStaffById["position"]){
                echo "<option selected value='$item[id_position]'>$item[name_position]</option>";
                    }
                    else{
                echo "<option value='$item[id_position]'>$item[name_position]</option>";
                    }
                }?>
           </select>
              <small></small>
            ...
            <div class="form-group col-md-3">
              ...
              <input required pattern="(84|0[3|5|7|8|9])+([0-9]{8})\b" class="form-control" name="phone_number" value="<?= $dataStaffById["phone_number"] ?>" type="text">
            ...
            <div class="form-group col-md-12">
             ...
             <img style="margin:15px 0;" height="400" src="<?php echo _WEB_ROOT;?>/app/public/assets/admin/images/<?= $dataStaffById['image']?>" width="400" src="" id="thumbimage"class="preview " height="200" alt="Image preview">
             </div>
                  <small></small>
                  <span></span>
            </div>
...
<script defer src="<?php echo _WEB_ROOT;?>/app/public/assets/admin/js/UpdateStaff.js"></script>
